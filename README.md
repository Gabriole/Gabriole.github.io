...
Explore the deployed project [here](https://gabriole.github.io) and read the [final project blog article](https://gabriole.github.io/bmi-blog-article).

For more information, connect with the author on [LinkedIn](https://www.linkedin.com/in/ismaïl-mouhtaram-02930228a/).
...
```bash
git clone https://github.com/Gabriole/bmi-calculator.git
